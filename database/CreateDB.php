...
private $tabaleInitializes=[
   ...
   ],'values'=>['hadis','hadis@gmail.com','12345','user'
...
public function run(){
    ...
    foreach ($this->tabaleInitializes as $tabaleInitialize){

        $this->insert($tabaleInitialize['table'],$tabaleInitialize['fields'],$tabaleInitialize['values']);
    }
